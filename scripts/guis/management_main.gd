...
func set_screen():
    ...
    $"MainScreen/VBoxContainer/ContentFrame/Inedible Waste/Waste/Amount/InedibleAmnt".text = str(Game.waste_hndlr.get_inedible_waste())
    $"MainScreen/VBoxContainer/ContentFrame/Edible Waste/Waste/Amount/EdibleAmnt".text = str(Game.waste_hndlr.get_edible_waste())
