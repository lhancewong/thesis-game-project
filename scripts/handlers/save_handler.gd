    ...
    while save_game.get_position() < save_game.get_len():
        ...
        for i in save_data.keys():
            ...
            match i:
                ...
                "meals_served_per_day": Game.meals_served_per_day = data
                "ingreds_bought_per_day": Game.ingreds_bought_per_day = data
                "ingreds_consumed_per_day": Game.ingreds_consumed_per_day = data
                "custos_served_per_day": Game.custos_served_per_day = data
                "satis_earned_per_day":Game.satis_earned_per_day = data
                "money_left_per_day": Game.money_left_per_day = data
                "money_spent_per_day": Game.money_spent_per_day = data
                "money_earned_per_day": Game.money_earned_per_day = data
                "e_waste_produced_per_day": Game.e_waste_produced_per_day = data
                "e_waste_managed_per_day": Game.e_waste_managed_per_day = data
                "e_waste_left_per_day": Game.e_waste_left_per_day = data
